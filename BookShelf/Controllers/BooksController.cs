...
namespace BookShelf.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["AuthorId"] = new SelectList(_context.Authors, "Id", "ApplicationUserId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ISBN,Title,Genre,PublishDate,AuthorId,ApplicationUserId")] Book book)
        {
            ...
            ViewData["AuthorId"] = new SelectList(_context.Authors, "Id", "ApplicationUserId", book.AuthorId);
            return View(book);
        }
